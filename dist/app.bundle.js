...
class ImagePanelModule {
    ...
    drawImage(x) {
        ...
        if (!myImg.imgElement) {
            ...
            img.src = myImg.name;
            img.onload = function() {
                ctx.drawImage(myImg.imgElement, __WEBPACK_IMPORTED_MODULE_0__resources_js__["constants"].imgCanvasOffset / 2, __WEBPACK_IMPORTED_MODULE_0__resources_js__["constants"].imgCanvasOffset / 2);
            }
...
class InfoPanelModule {
    ...
    drawCanvas() {
        const infoPanel = document.getElementById(__WEBPACK_IMPORTED_MODULE_0__resources_js__["elementIds"].infoPanel);
        const canvas = document.createElement("canvas");
...
/* harmony export (immutable) */ __webpack_exports__["b"] = InfoPanelModule;
...
class ControlModule {
    ...
    drawCanvas() {
        const controlPanel = document.getElementById(__WEBPACK_IMPORTED_MODULE_0__resources_js__["elementIds"].controlPanel);
        const canvas = document.createElement("canvas");
...
/* harmony export (immutable) */ __webpack_exports__["d"] = ControlModule;
